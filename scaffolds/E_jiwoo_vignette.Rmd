...
<!--
  ============================================================
  JumpDiffSim -- Student Scaffold
  Member  : Choi Jiwoo (E)
  Role    : Vignette and README
  File    : vignettes/JumpDiffSim-intro.Rmd
  Branch  : feature/jiwoo-vignette
  ...
  INSTRUCTIONS:
    ...
    2. Run devtools::build_vignettes() to check it knits
    3. Run browseVignettes("JumpDiffSim") to view in browser
    4. Must knit offline in under 60 seconds
    5. Do NOT add any code that downloads data from the internet
  ============================================================
-->
